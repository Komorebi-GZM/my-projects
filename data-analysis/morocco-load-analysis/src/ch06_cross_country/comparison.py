...
产物输出到: outputs/ch06_cross_country_comparison/
"""
...
# Step 6.1: 对标城市基础信息整理
# ============================================================
def step_6_1_benchmark_info():
    """整理西宁、银川、酒泉三个中国对标城市的基础信息"""
    print('\n' + '=' * 60)
...
# Step 6.2: 国家统计局数据爬取
# ============================================================
def step_6_2_nbs_scraping():
    """从国家统计局爬取省级行政区数据，失败则使用手动录入"""
    print('\n' + '=' * 60)
...
# Step 6.3: 地方电网公开数据爬取
# ============================================================
def step_6_3_grid_scraping():
    """从地方电网网站爬取数据，失败则使用手动录入"""
    print('\n' + '=' * 60)
...
# Step 6.4: 气象数据获取 (OpenMeteo API)
# ============================================================
def step_6_4_climate_data(cities_info):
    """获取气象数据（OpenMeteo API），失败则使用手动录入"""
    print('\n' + '=' * 60)
...
# Step 6.5: 爬虫数据清洗与标准化
# ============================================================
def step_6_5_clean_and_merge(cities_info):
    """清洗标准化所有数据，构建中摩城市对比面板"""
    print('\n' + '=' * 60)
...
# Step 6.6: 多维度对比分析可视化
# ============================================================
def step_6_6_visualization(panel):
    """生成多维度对比图表"""
    print('\n' + '=' * 60)
...
# Step 6.7: 差异性归因解释
# ============================================================
def step_6_7_attribution_report(panel, cities_info):
    """生成差异性归因分析报告"""
    print('\n' + '=' * 60)
...
def main():
    print('=' * 60)
    print('Prompt-06: Cross-Country Comparison')
    print('=' * 60)

    ensure_dir(OUTPUT_DIR)

    # Step 6.1
    cities_info = step_6_1_benchmark_info()

    # Step 6.2
    step_6_2_nbs_scraping()

    # Step 6.3
    step_6_3_grid_scraping()

    # Step 6.4
    step_6_4_climate_data(cities_info)

    # Step 6.5
    panel = step_6_5_clean_and_merge(cities_info)

    # Step 6.6
    step_6_6_visualization(panel)

    # Step 6.7
    step_6_7_attribution_report(panel, cities_info)
